...
public class ConsolaOlimpicos
{
	 ...
	 * 
	 */
	private void ejercutarPaisAtleta() 
	{
		System.out.println("\n" + "Pais de un atleta" + "\n");
		String Name = input("Escriba el nombre del atleta");

		Pais info = calculadora.NamePais(Name);
		System.out.println("El pais del atleta "+ Name +" es: " + info.darNombre());
